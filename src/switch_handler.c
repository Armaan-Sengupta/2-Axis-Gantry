...
{    
    ...
    {
    case 10:
        if (handle_on_axis(MOTOR_X_FORWARD)) stop_motor(MOTOR_X);
        break;
    case 8:
        if (handle_on_axis(MOTOR_X_BACKWARD)) stop_motor(MOTOR_X);
        break;
    case 9:
        if (handle_on_axis(MOTOR_Y_FORWARD)) stop_motor(MOTOR_Y);
        break;
    case 4:
        if (handle_on_axis(MOTOR_Y_BACKWARD)) stop_motor(MOTOR_Y);
        break;
    default:
        break;
    }
